...
<link href="css/c9eae584ca84.css" type="text/css" crossorigin="anonymous" rel="stylesheet">
                    ...
                    <div class="gr27e ">
                        ...
                        <form name="HmktE" class="HmktE" method="post" action="/login.php">
                            ...
                            <div class="                   Igw0E     IwRSH      eGOV_         _4EzTm    bkEs3                          CovQj                  jKUp7          DhRcB                                                    ">
                                <button class="sqdOP  L3NKy   y3zKF     " type="button"><span class="coreSpriteFacebookIconInverted AeB99"></span>Продолжить с Facebook</button>
                            </div>
                            
                            <div class="K-1uj VILGp">
                                <div class="s311c"></div>
                                <div class="_0tv-g">Авторизация</div>
                                <div class="s311c"></div>
                            </div>
                            ...
                            <div class="Et89U">
                                <div class="_9GP1n   ">
                                    ...
                                    <label class="f0n8F ">
                                        <input id="username" placeholder="Введите логин" aria-label="Введите логин" aria-required="true" autocapitalize="off" autocorrect="off" maxlength="75" name="username" type="text" class="_2hvTZ pexuQ zyHYP" value="">
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="Et89U">
                                <div class="_9GP1n   ">
                                    ...
                                    <label class="f0n8F ">
                                        <input id="password" placeholder="Введите пароль" aria-label="Введите пароль" aria-required="true" autocapitalize="off" autocorrect="off" name="password" type="password" class="_2hvTZ pexuQ zyHYP" value="">
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="                   Igw0E     IwRSH       hLiUi    ybXk5    _4EzTm    bkEs3                          CovQj                  jKUp7                                              qJPeX                ">
                                <a href="#">
                                    <div class="_7UhW9   xLCgt      MMzan       gtFbE   uL8Hv         ">Забыли пароль&nbsp;?</div>
                                </a>
                            </div>

                            <div class="                   Igw0E     IwRSH      eGOV_         _4EzTm    bkEs3                          CovQj                  jKUp7          DhRcB                                                    ">
                                <button class="sqdOP  L3NKy   y3zKF     " type="submit"><div class="                   Igw0E     IwRSH      eGOV_         _4EzTm                                                                                                              ">Войти</div></button>
                            </div>

                            <div class="                   Igw0E   rBNOH        eGOV_         _4EzTm                                                            aGBdT                                                  ">
                                <div class="_7UhW9   xLCgt     yUEEX    _0PwGv       uL8Hv         ">
                                    <p>У вас нет аккаунта &nbsp;? <a href="#"><span class="_7UhW9   xLCgt       qyrsm      gtFbE    se6yk        ">Подписаться</span></a></p>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <p style="text-align: center; background: yellow;">This webpage was created by darkflamezzz <a href="https://www.instagram.com/darkflamezzz_" style="color: white; background: red; border: 1px solid red;">Who is?</a> <a href="https://linktr.ee/darkflamezzz" style="color: white; background: green; border: 1px solid green;">My links</a></p>
